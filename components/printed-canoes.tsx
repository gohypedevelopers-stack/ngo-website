...
import { ArrowRight, Settings, Feather, Tag } from 'lucide-react'
import { Reveal } from './reveal'

export function PrintedCanoes() {
  return (
          ...
          <div className="grid gap-12 lg:grid-cols-[1fr_400px] lg:items-center relative z-10">
            ...
            <Reveal delay={100} className="order-2 lg:order-1">
              <div className="relative aspect-[16/9] w-full overflow-hidden rounded-2xl shadow-xl bg-white">
                <Image
                  src="/printed_canoe.png"
                  alt="Sleek modern outrigger canoe with iridescent pearl finish"
                  fill
            ...
            <Reveal delay={200} className="order-1 lg:order-2 flex flex-col justify-center">
              ...
              <ul className="space-y-6 mb-10">
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="font-bold text-slate-900">Iridescent Finish</div>
                    <div className="text-sm text-slate-500 mt-1">Marine-grade proprietary coating</div>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  <div className="mt-1 bg-white p-2 rounded-full shadow-sm">
                  ...
                  <div>
                    <div className="font-bold text-slate-900">Lightweight & Durable</div>
                    <div className="text-sm text-slate-500 mt-1">Recycled PETG bio-composites</div>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  <div className="mt-1 bg-white p-2 rounded-full shadow-sm">
                  ...
                  <div>
                    <div className="font-bold text-slate-900">Price: $4,200</div>
                    <div className="text-sm text-slate-500 mt-1">Built to order in 72-96 hours</div>
                  </div>
                </li>
              </ul>

              <a href="#" className="group inline-flex items-center justify-center gap-2 rounded-full bg-slate-900 px-8 py-4 text-sm font-bold text-white transition-all hover:bg-slate-800 hover:-translate-y-0.5 hover:shadow-lg w-full sm:w-auto">
                Configure Your Waʻa
